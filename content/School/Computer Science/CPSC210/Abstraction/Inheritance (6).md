...
- An interface class **cannot** be initialized
- **Once a method specced in an interface is overridden in a class hierarchy by a class, all subtypes of that class will still compile and need not have their own implementation** 
...
- Java works up the hierarchy of actual types to find implementations (this is called method dispatching)
